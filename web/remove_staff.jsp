...
<body style="color: white;">
    ...
    %>
                    <tr>
                        <td class="hod_name" align="center">
                            <a href="admin_hod_remove.jsp?username=<%=rs1.getString("uname") %>">
                                <%=rs1.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td style="padding-left: 40px;" class="staff_name">
                            <a href="admin_staff_remove.jsp?username=<%=rs1.getString("uname") %>">
                                <%=rs1.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td class="hod_name" align="center">
                            <a href="admin_hod_remove.jsp?username=<%=rs2.getString("uname") %>">
                                <%=rs2.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td style="padding-left: 40px;" class="staff_name">
                            <a href="admin_staff_remove.jsp?username=<%=rs2.getString("uname") %>">
                                <%=rs2.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td class="hod_name" align="center">
                            <a href="admin_hod_remove.jsp?username=<%=rs3.getString("uname") %>">
                                <%=rs3.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td style="padding-left: 40px;" class="staff_name">
                            <a href="admin_staff_remove.jsp?username=<%=rs3.getString("uname") %>">
                                <%=rs3.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td class="hod_name" align="center">
                            <a href="admin_hod_remove.jsp?username=<%=rs4.getString("uname") %>">
                                <%=rs4.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td style="padding-left: 40px;" class="staff_name">
                            <a href="admin_staff_remove.jsp?username=<%=rs4.getString("uname") %>">
                                <%=rs4.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td class="hod_name" align="center">
                            <a href="admin_hod_remove.jsp?username=<%=rs5.getString("uname") %>">
                                <%=rs5.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td style="padding-left: 40px;" class="staff_name">
                            <a href="admin_staff_remove.jsp?username=<%=rs5.getString("uname") %>">
                                <%=rs5.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td class="hod_name" align="center">
                            <a href="admin_hod_remove.jsp?username=<%=rs6.getString("uname") %>">
                                <%=rs6.getString("name") %>
                            </a>
                        </td>
                    </tr>
    ...
    %>
                    <tr>
                        <td style="padding-left: 40px;" class="staff_name">
                            <a href="admin_staff_remove.jsp?username=<%=rs6.getString("uname") %>">
                                <%=rs6.getString("name") %>
                            </a>
                        </td>
                    </tr>
