...
<body>
        ...
        <div style="text-align: end; width: 1175px;">
            <div style="position: absolute; padding-top: 3px;" class="dropdown">
                ...
                <div id="myDropdown" class="dropdown-content" align="left">
                    <a href="hod_profile.jsp?username=<%=uname%>">Profile</a>
    ...
    <div align="center" style="padding-top: 10px;">
        <a href="hod_page.jsp"><img src="WebContent/static/images/home_page.jpg" style="width: 100px; height: 75px; background: transparent; border: none;"></a>
    </div>
</body>
</html>
